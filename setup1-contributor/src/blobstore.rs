...
use azure_sdk_storage_blob::{
    blob::{BlobBlockType, BlockList, BlockListSupport},
...
use std::{cmp, convert::TryFrom, fs::File, io::prelude::*, ops::Deref};
use url::Url;
...
pub async fn upload_with_client(client: &KeyClient, container: &str, path: &str, file_path: &str) -> Result<()> {
